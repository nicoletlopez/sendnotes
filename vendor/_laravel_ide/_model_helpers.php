...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereBody($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereSendDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereIsPublished($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereHeartCount($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereRecipient($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note select(mixed $columns)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note addSelect(mixed $column)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereRaw(\Illuminate\Contracts\Database\Query\Expression|string $sql, mixed $bindings, string $boolean)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereValueBetween(mixed $value, array{: \Illuminate\Contracts\Database\Query\Expression|string, : \Illuminate\Contracts\Database\Query\Expression|string} $columns, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note orWhereValueBetween(mixed $value, array{: \Illuminate\Contracts\Database\Query\Expression|string, : \Illuminate\Contracts\Database\Query\Expression|string} $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note whereValueNotBetween(mixed $value, array{: \Illuminate\Contracts\Database\Query\Expression|string, : \Illuminate\Contracts\Database\Query\Expression|string} $columns, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note orWhereValueNotBetween(mixed $value, array{: \Illuminate\Contracts\Database\Query\Expression|string, : \Illuminate\Contracts\Database\Query\Expression|string} $columns)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note having(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, \DateTimeInterface|string|int|float|null $operator, \Illuminate\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note orHaving(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, \DateTimeInterface|string|int|float|null $operator, \Illuminate\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null $value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note reorderDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column)
     ...
     * @method static Note|null find(int|string $id, string|\Illuminate\Contracts\Database\Query\Expression|(string|\Illuminate\Contracts\Database\Query\Expression)[] $columns)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note setAggregate(string $function, (\Illuminate\Contracts\Database\Query\Expression|string)[] $columns)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note setBindings(list $bindings, "select"|"from"|"join"|"where"|"groupBy"|"having"|"order"|"union"|"unionOrder" $type)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note addBinding(mixed $value, "select"|"from"|"join"|"where"|"groupBy"|"having"|"order"|"union"|"unionOrder" $type)
     * @method static mixed castBinding(mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note mergeBindings(self $query)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note wherePastOrFuture(array|string $columns, string $operator, string $boolean)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note orWhereTodayOrBefore(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note orWhereAfterToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<Note>|Note orWhereTodayOrAfter(array|string $columns)
